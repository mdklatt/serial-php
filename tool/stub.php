...
// This was adapted from code generated by Phar::createDefaultStub() to fix the
// limitations of the default stub, namely that its global definitions make it
// impossible to use in phar files that might be used simulataneously. The
...
PharExtractor::extract(__FILE__, 'Serial/Core.php', 8137);
__HALT_COMPILER(); ?>
